...
__all__ = ["kpi_config", "resources_path"]

resources_path: Final[str] = "kpi.config.resources"

_resources_traversable: Final[Traversable] = files(resources_path)
_config_file: Final[Traversable] = _resources_traversable / "kpi.toml"
...
with open(str(_config_file), mode="rb") as reader:
    ...
    kpi_config: Final = _root_config.get("kpi", {})
